...
$( ".aq-block-aq_content_block:eq(0)" ).css("background-color", "#FE7E17").addClass('contentblock0');
...
$( ".aq-block-aq_content_block:eq(3)" ).css("background", "#FE7E17").addClass('contentblock3');
